...
// Interface pour l'utilisateur du système
interface User {
  id?: number;
  username: string;
  email: string;
...
export class ProfileComponent implements OnInit {
    ...
    this.notifications = [
      {
        ...
        message: 'Le produit "Clavier sans fil" a été ajouté à l\'inventaire',
        date: new Date(),
        type: 'info',
        read: false
      },
      {
        id: 2,
        title: 'Stock faible',
        message: 'Le produit "Souris optique" est presque en rupture de stock',
      ...
      },
      {
        ...
        message: 'Un inventaire complet est requis avant la fin du mois',
  ...
  /**
   * Charge les statistiques du magasinier
   */
  loadStats(): void {
